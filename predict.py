...
def run(
        ...
        source=ROOT / 'traffic_video',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'traffic_video.mp4', help='file/dir/URL/glob, 0 for webcam')
